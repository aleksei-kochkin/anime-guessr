...
export default function GameStats({ round, score, correctRounds, className = '' }: GameStatsProps) {
  ...
  return (
    <div className={`flex justify-center items-center gap-3 sm:gap-6 ${className}`}>
      <div className="text-center">
        <div className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">{UI_TEXT.STATS.ROUND}</div>
        <div className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">{round}</div>
      </div>
      ...
      <div className="text-center">
        ...
        <div className="text-lg sm:text-xl font-bold text-green-600 dark:text-green-400">{score}</div>
      </div>
      ...
      <div className="text-center">
        ...
        <div className="text-lg sm:text-xl font-bold text-blue-600 dark:text-blue-400">{accuracy}%</div>
      </div>
    </div>
  );
}
